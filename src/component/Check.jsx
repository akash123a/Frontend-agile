...
//     'TO DO': [
//       { id: 'MBA-5', title: '(Sample) Two-Factor Authentication Setup', tag: 'USER AUTHENTICATION', priority: 'high', description: '', comments: [] }
//     ],
//     'IN PROGRESS': [
//       { id: 'MBA-7', title: 'kunan', tag: '', priority: 'medium', description: '', comments: [] },
//       { id: 'MBA-6', title: '(Sample) Implement Biometric Login', tag: 'USER AUTHENTICATION', priority: 'high', description: '', comments: [] }
//     ],
//     'DONE': [
//       { id: 'MBA-3', title: '(Sample) Initiate Fund Transfer', tag: 'TRANSACTION MANAGEMENT', priority: 'low', description: '', comments: [] },
//       { id: 'MBA-4', title: '(Sample) View Transaction History', tag: 'TRANSACTION MANAGEMENT', priority: 'medium', description: '', comments: [] }
//     ]
//   });
...
//     const taskId = `MBA-${Math.floor(Math.random() * 1000)}`;
//     const task = {
//       id: taskId,
//       ...newTask
//     };
...
//               <img src="https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=48&h=48&fit=crop" 
//                    alt="Project" 
...
//             <h1 className="text-xl font-semibold">MBA board</h1>
...
//             <div
//               key={columnTitle}
//               className="bg-gray-50 rounded-lg p-4 w-80 flex-shrink-0"
//               onDragOver={handleDragOver}
//               onDrop={(e) => handleDrop(e, columnTitle)}
//             >
//               <h3 className="font-medium mb-4 flex items-center justify-between">
//                 {columnTitle} <span className="text-gray-500">{columnTasks.length}</span>
//               </h3>
...
//                     key={task.id}
//                     draggable
//                     onDragStart={(e) => handleDragStart(e, task, columnTitle)}
...
//       {/* Create Issue Modal */}
//       {/* ... (Create Issue Modal code remains the same) */}
//       {isModalOpen && (
//         <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
//           <div className="bg-white rounded-lg p-6 w-[500px]">
//             <div className="flex justify-between items-center mb-4">
...
//       {/* Project Modal */}
//       {/* ... (Project Modal code remains the same) */}
//       {isProjectModalOpen && (
//         <ProjectModal
//           onClose={() => setIsProjectModalOpen(false)}
//           onSave={handleCreateProject}
...
//           <IconButton sx={{ position: 'absolute', right: 8, top: 8 }} onClick={() => setOpenInviteModal(false)}><Close /></IconButton>
//         </DialogTitle>
//         <DialogContent dividers>
//           <Grid container spacing={3}>
//             <Grid item xs={12}><TextField fullWidth label="Email" type="email" value={newInvite.email} onChange={(e) => setNewInvite({ ...newInvite, email: e.target.value })} /></Grid>
//             <Grid item xs={12}>
//               <TextField select fullWidth label="Role" value={newInvite.role} onChange={(e) => setNewInvite({ ...newInvite, role: e.target.value })}>
//                 {['Member', 'Admin', 'Viewer'].map(role => <MenuItem key={role} value={role}>{role}</MenuItem>)}
//               </TextField>
//             </Grid>
//           </Grid>
//         </DialogContent>
...
//           <Button variant="contained" onClick={handleSendInvite} startIcon={<Send />}>Send Invite</Button>
//         </DialogActions>
//       </Dialog>
//     </div>
//   );
...
//               <div className="flex justify-end space-x-3 mt-6">
//                 <button onClick={() => setIsModalOpen(false)} className="px-4 py-2 border rounded-md hover:bg-gray-50">
//                   Cancel
//                 </button>
//                 <button onClick={handleCreateTask} className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
//                   Create Issue
//                 </button>
//               </div>
//             </div>
...
// iss pahle  ye  code  chal  raha tha  ye  code  hai  jo  abhi  nahi  chal raha hai
